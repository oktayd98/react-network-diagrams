  ...
  _createClass(Node, [{
    ...
    value: function render() {
      ...
      if (this.props.shape === 'cloud') {
        ...
        labelX -= 3;
      } else if (this.props.shape === 'network') {
        ...
        nodeElement = _react2.default.createElement('image', {
          href: 'https://cdn0.iconfinder.com/data/icons/computer-and-hardware-free/32/Computer__Computer_Hardware_Wifi_Router_Signal_Internet-256.png',
          height: '50',
          width: width,
          x: x,
          y: y
      ...
      } else if (this.props.shape === 'server') {
        nodeClasses += ' map-node-shape-square';
        labelClasses += ' map-node-shape-square';
        var _x = this.props.x - this.props.radius;
        var _y = this.props.y - this.props.radius;
        var _width = 2 * this.props.radius;
        nodeElement = _react2.default.createElement('image', {
          href: 'https://cdn2.iconfinder.com/data/icons/whcompare-isometric-web-hosting-servers/50/value-server-256.png',
          height: '50',
          width: _width,
          x: _x,
          y: _y
        ...
        nodeClasses += ' map-node-shape-square';
        labelClasses += ' map-node-shape-square';
        var _x2 = this.props.x - this.props.radius;
        var _y2 = this.props.y - this.props.radius;
        var _width2 = 2 * this.props.radius;
      ...
      } else if (this.props.shape === 'area') {
        nodeClasses += ' map-node-shape-square';
        labelClasses += ' map-node-shape-square';
        var _x3 = this.props.x - this.props.radius;
        var _y3 = this.props.y - this.props.radius;
        nodeElement = _react2.default.createElement('rect', {
          x: _x3,
          y: _y3,
          rx: this.props.rx,
     ...
     */
    value: function spec() {
      return [{ attr: 'name', label: 'Name', type: 'text' }, { attr: 'x', label: 'Position x', type: 'integer' }, { attr: 'y', label: 'Position y', type: 'integer' }, { attr: 'label_dx', label: 'Label offset x', type: 'integer' }, { attr: 'label_dy', label: 'Label offset y', type: 'integer' }, { attr: 'width', label: 'Width', type: 'integer' }, { attr: 'height', label: 'Height', type: 'integer' }, {
        attr: 'label_position',
...
Node.propTypes = {
  ...
  shape: _propTypes2.default.oneOf(['circle', 'square', 'cloud', 'server', 'network', 'area']),
